...
def main():
    ...
    line_path = sweep_dir / f"plot_wscale_vs_acc_shift{shift_val}_{bias_mode}.png"
    ...
    heatmap_path = sweep_dir / f"heatmap_xscale_wscale_acc_shift{shift_val}_{bias_mode}.png"
    ...
    sat_path = sweep_dir / f"scatter_fc3sat_vs_acc_shift{shift_val}_{bias_mode}.png"
